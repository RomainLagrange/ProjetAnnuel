...
def page2_cpp(document, extract):
    ...
    paragraph=document.add_paragraph('1. Numéro EudraCT :\n'+ extract['num_eudract'], style='page2_normal')
    paragraph=document.add_paragraph('2. Titre complet de la recherche :\n' + extract['titre_complet'], style='page2_normal')
    paragraph=document.add_paragraph('3. Justification et analyse critique de la pertinence de la recherche :\n' + extract ['justification_etude_courte'], style='page2_normal')
    ...
    paragraph=document.add_paragraph('8. Procédures d’investigation menées et différences par rapport à la prise en charge habituelle, le cas échéant :\n', style='page2_normal')
