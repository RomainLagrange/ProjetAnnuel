...
def Partie7(document):
    'Creation de la partie 7 du protcole de catégorie 3'
...
#        section.right_margin = Cm(2)
 ...
 #   Style(document)
    ...
    Titre1('7	GESTION DES ÉVÉNEMENTS INDÉSIRABLES/ EFFETS INDESIRABLES/INCIDENTS',document)
   ...
   # document.save("Cat3Partie7.docx")   