# -*- coding: utf-8 -*-
"""
Created on Thu Feb 21 16:58:25 2019
...
def Partie14(document):
    'Creation de la partie 14 du protcole de catégorie 2'
...
#---------------------------------------------------------------ECRITURE
    ...
    Titre1('14	CONSERVATION DES DOCUMENTS ET DES DONNEES RELATIFS A LA RECHERCHE',document)
